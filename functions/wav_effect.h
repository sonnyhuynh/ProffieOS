...
public:	
  ...
  const char* GetEffectName(BladeEffectType type) {
	  switch (type){
       ...
       //added for ProffiOS 5.2
	   // case EFFECT_LOW_BATTERY:   return "none";
	   // case EFFECT_POWERSAVE:     return "none";
	   // case EFFECT_BATTERY_LEVEL: return "none";
	   // case EFFECT_FAST_ON:	   	return "none";
	   // case EFFECT_USER1:	   	return "none";
	   // case EFFECT_USER2:	   	return "none";
	   // case EFFECT_USER3:	   	return "none";
	   // case EFFECT_USER4:	   	return "none";
	   // case EFFECT_USER5:	   	return "none";
